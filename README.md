...
Colección de cursos y guías de aprendizaje sobre temas variados, producidos para leer en sesiones cortas.

Cada curso vive en su propia carpeta y contiene una serie de píldoras (lecciones) de unos 10 minutos, autocontenidas en HTML, abribles directamente desde el navegador.

## Cursos publicados

- **[Panorama competitivo de comercializadoras eléctricas en España](comercializadoras-espana-competencia/indice.html)** — Quién compite con quién, datos económicos reales, casos de quiebra (Holaluz) y modelos innovadores. 7 píldoras × 10-12 min + evaluación.
...
- **[Petarlo en LinkedIn en 2026](petarlo-en-linkedin-2026/indice.html)** — Guía estratégica y práctica para crecer en LinkedIn. 10 píldoras × 10 min.

## Ver online

Si estás leyendo esto en GitHub, los cursos también se sirven directamente vía GitHub Pages en:

**https://acosta1991.github.io/mis-guias/**
